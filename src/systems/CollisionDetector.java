...
public class CollisionDetector {
    ...
    public void mapCollision() {
        ...
        if(GameState.isInGreenLandMap){
            ...
            Rectangle objectOneLeftWall = new Rectangle(200, gamePanel.getHeight() - 225, 10, 225);

            // MAP COLLISION
            Rectangle collisionWallLeft = new Rectangle(-55, 0, 60, gamePanel.getHeight());
            Rectangle collisionWallTop = new Rectangle(0, -55, gamePanel.getWidth(), 60);
        ...
        if(GameState.isInDarkLandMap){
            ...
            Rectangle collisionWallRight = new Rectangle(gamePanel.getWidth() - 5, 0, 60, gamePanel.getHeight());
        ...
        if(GameState.isInSnowLandMap){
            ...
            Rectangle collisionWallDown = new Rectangle(0, gamePanel.getHeight() - 5, gamePanel.getWidth(), 60);
